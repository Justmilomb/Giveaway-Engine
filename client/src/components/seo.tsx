...
export function SEO({
  ...
  keywords = "instagram giveaway generator, instagram comments picker, no login giveaway tool, no signup, one-time payment, random winner selector, pick us a winner, giveaway generator, comment picker",
  image = defaultImage,
  url,
  type = "website",
  noindex = false,
